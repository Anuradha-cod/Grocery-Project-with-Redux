  ...
  return (
    <div className="footer">
      <div className="f-grofer">
        <h2>Grofers - Online Grocery Shopping</h2>
      ...
      <div className="footer-follow">
       <h3>Follow Us</h3>
<img className="footer-img1" src="https://constant.myntassets.com/web/assets/img/d2bec182-bef5-4fab-ade0-034d21ec82e31574604275433-fb.png"/>
       <img className="footer-img1"  src="https://constant.myntassets.com/web/assets/img/f10bc513-c5a4-490c-9a9c-eb7a3cc8252b1574604275383-twitter.png" />
       <img className="footer-img1"  src="https://constant.myntassets.com/web/assets/img/a7e3c86e-566a-44a6-a733-179389dd87111574604275355-yt.png" />
       <img className="footer-img1"  src="https://constant.myntassets.com/web/assets/img/b4fcca19-5fc1-4199-93ca-4cae3210ef7f1574604275408-insta.png" />
      </div>
    </div>
  );
}
